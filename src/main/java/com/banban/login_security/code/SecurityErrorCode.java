...
public enum SecurityErrorCode implements Code{
    // 바꿀 수 없는 에러는 400번대로
    // 재요청하거나 대응할 수 있는 에러는 1000번대로
    TOKEN_AUTHENTICATION_FAILED(404, "토큰 인증 실패"),
    UNKNOWN_ERROR(404, "알 수 없는 에러"),
    SECURITY_USER_NOT_FOUND(404, "유저를 찾을 수 없습니다."),
    SECURITY_PASSWORD_IS_WRONG(404, "패스워드가 틀립니다."),
    SECURITY_AUTH_WRONG(404, "아이디나 비밀번호가 틀립니다."),
    ACCESS_DENIED(404, "접근 금지"),

    CUSTOM_WRONG_TYPE_TOKEN(404, "잘못된 타입의 토큰"),
    CUSTOM_EXPIRED_TOKEN(404, "토큰이 만료됨"),
